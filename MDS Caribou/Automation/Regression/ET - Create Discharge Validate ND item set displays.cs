...
{
    [TestFixture]
    class ET___Create_Discharge_Validate_ND_item_set_displays
    {
        [Test]
        public void ET_Create_Discharge_Validate_ND_item_set_displays()
        {
            Browser.Open();
            LoginPage.SignIn();
            ...
            //Step 5  Select the correct coding for an ND item set.
            ...
            //Step 7  By comparing with the currently coded specs, verify that the assessment that is displayed, matches that of the CMS ND items set spec from the manual. 
