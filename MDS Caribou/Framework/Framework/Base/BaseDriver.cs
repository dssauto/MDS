...
{
    public class BaseDriver : BaseSetup
    {
        public static IWebDriver Instance { get; set; }
        public static void Initialize()
        {
            var outPutDirectory = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            var relativePath = @"..\..\..\Framework\Framework\bin\Debug";
        ...
        {
            var outPutDirectory = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            var relativePath = @"..\..\..\Framework\Framework\packages\PhantomJS.2.1.1\tools\phantomjs";
            var driverPath = Path.GetFullPath(Path.Combine(outPutDirectory, relativePath));
